...
# --- 1. 상수 정의 ---
# --------------------------------------------------------------------------
# 📍 입력 파일 (LLM으로 날짜 추출이 완료된 파일)
AUGMENTED_JSON_PATH = 'skku_augmented.json'

# 📍 출력 파일 및 디렉터리 (이 스크립트가 생성할 파일들)
CHROMA_DB_PATH = './skku_notice_db'  # Vector DB 저장될 디렉터리
